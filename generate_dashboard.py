...
<body>
    <div class="container">
        ...
        <div class="card full-width-card" style="margin-bottom: 30px; background-color: #1e293b; padding: 24px; border-radius: 12px; border: 1px solid var(--border-color); border-left: 5px solid var(--red);">
            <h3 style="font-size: 1.4rem; font-weight: 700; text-align: left; margin-bottom: 12px; color: #f87171;">The Illusion of Expertise: Institutional Forecasts Are Statistically Worthless</h3>
            <p>
                An exhaustive statistical analysis of the historical data reveals a definitive conclusion: <strong>there is no statistically significant correlation between institutional predictions and actual stock market returns</strong>. 
                Whether nominal or inflation-adjusted (real), Wall Street's long-term forecasts are essentially worthless for asset allocation.
            </p>
            <p style="margin-top: 12px;">
                Specifically, nominal predictions have a correlation coefficient of <strong>-0.2119</strong> (\(p\)-value = `0.3564`), meaning they are slightly negatively correlated and statistically indistinguishable from random guesses. 
                Real forecasts show a moderate positive correlation (\(r = 0.4110\)), but with a \(p\)-value of `0.1630`, they also fail to achieve statistical significance. 
                The apparent "significance" in combined views is a mathematical illusion created solely by mixing nominal and inflation-adjusted scales.
            </p>
            <p style="margin-top: 12px;">
                <strong>Herd Mentality Over Analysis:</strong> Rather than performing objective forecasting, institutions suffer from extreme consensus clustering. 
                Nearly 100% of nominal predictions are huddled safely in the <strong>4.0% to 8.0% return range</strong>. 
                By copying one another and predicting a narrow, average outcome, asset managers insulate themselves from individual criticism—making their forecasts a tool for marketing and career defense rather than accurate market projection.
            </p>
        </div>
